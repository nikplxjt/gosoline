 ...
 * 1) Set a break point in GosolineApiserverGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class GosolineApiserverGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("gosoline-apiserver") // use this codegen library
              ...
              .setOutputDir("out/gosoline-apiserver"); // output directory
